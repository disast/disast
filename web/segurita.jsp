<%-- 
    Document   : segurita
    Created on : 27/05/2013, 09:49:54 AM
    Author     : Lunita
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="Scripts/socupacional.js" ></script> 
    </head>
    <body>
        <div class="sheet">
            <div class="sheet_body">
                ...
                <nav class="nav">
                    <ul class="menu">
                        <li><a href="#" id="Salud_Ocupacional">Salud Ocupacional</a></li>
                        <li><a href="#" id="Perfil_Salud_Ocupacional">Perfil</a></li>
